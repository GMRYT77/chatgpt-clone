...
export default function Home() {
  ...
  return (
    <main className="w-full h-screen bg-[#212121] flex flex-col">
      <div className="w-full flex-1 relative">
        <div className="w-full absolute top-0 left-0 px-4 py-2 items-center flex justify-between bg-[#212121]">
          <button
            onClick={openMenu}
        ...
        <div className="w-full h-full flex flex-col items-center justify-center gap-12 overflow-y-hidden px-4">
          <svg
            width="41"
            height="41"
            viewBox="0 0 41 41"
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-200/70">
            <div className="flex gap-4">
              <div className="rounded-xl cursor-pointer space-y-1 font-light border border-gray-400/10 p-3 w-40 h-28 transition hover:bg-gray-400/10">
                <span>ic</span>
        ...
        <div className="w-full p-4 flex flex-col items-center  absolute bottom-0 left-0">
          <div className="w-full max-w-screen-md mx-auto relative">
            <input
              ...
              className="text-neutral-100 placeholder:text-gray-400 outline-none font-light text-sm bg-[#2f2f2f] rounded-full w-full px-5 py-4"
            />
          </div>
      ...
      <div
        ...
        className="hidden absolute top-0 left-0 w-full h-screen bg-black/70 z-30 md:hidden"
      ></div>
    </main>
  );
}
