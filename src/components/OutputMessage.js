...
const OutputMessage = ({ e, promptOutput, endRef, model }) => {
      ...
      <div className="flex w-full max-w-[90%] gap-6 relative">
        ...
        <div className="flex-1 flex flex-col relative overflow-x-hidden">
          <div className="text-gray-200 flex flex-col">
            {/* {Markdown({ markdown: e?.data().text })} 
            {/* {Markdown({ markdown: promptOutput })} */}
            {e?.data().responded
              ? Markdown({ markdown: e?.data().text })
          ...
          {e?.data().responded ? (
            <div className="w-full pt-3 flex gap-1">
              ...
              <div className="flex rounded-sm hover:bg-[#2f2f2f] p-1 text-gray-400 items-center cursor-pointer group">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
                ...
                <div
                  className="text-sm font-light text-[#aaaaaa] overflow-x-hidden transition-all duration-300  
                ease-in-out w-0 group-hover:w-full group-hover:ml-1 whitespace-nowrap"
                >
                ...
                <span>
                  <IoChevronDownOutline className="text-[#727272] ml-0.5 text-[95%]" />
                </span>
              </div>
            </div>
          ) : (
